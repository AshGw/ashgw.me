...
You can also create a function that checks
 the signature of another function, if it adheres to the protocol or not, and provide helpful error messages why the given object does not adhere to the protocol
</C>
<Code
  code={`import inspect 
