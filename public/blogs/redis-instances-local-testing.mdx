...
<C>
  ...
  framework and <L href="https://python-poetry.org/">Poetry</L> as the package manager, 
...
<S3 />
<C>
  For the rate limiting logic, we'll use <L href="https://github.com/long2ice/fastapi-limiter/">``fastapi_limiter``</L>. Though you can
  roll out your own.
</C>
...
<C>
  ...
  <S3 />
  To actually run it we need a Dockerfile:
</C>
