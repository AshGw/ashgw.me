...
<S3/>
<C>
Study code from successful projects like the ones with many starts on GitHub. By analyzing professional code (we can argue if it is or not later) written in the languages you're learning, you'll discern patterns, anti-patterns, design principles, best practices and more. They don't teach these things in colleges
</C>
<S3/>
<C>
