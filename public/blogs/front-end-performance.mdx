...
<C>
It's 2021, you're probably using a bundler (<L href='https://vitejs.dev'>Vite</L>, <L href='https://webpack.js.org'>WebPack</L>, <L href='https://rollupjs.org'>Rollup</L>, <L href='https://parceljs.org/docs/'>Parcel</L>...) already for JS, so that's in check.
</C>
<C>
