...
<C>
Software development is primarily about problem-solving, just like maths. Before you attempt to solve integrals and differential equations, you must assess your current knowledge level first. If you know absolutely nothing about math, they must start with basic arithmetic and go from there.
</C>
