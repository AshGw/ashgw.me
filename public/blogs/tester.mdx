...
<C>
   To  azeaze <L href={'https://google.com'}> install</L> and run the app on any machine, you can choose from two methods:

Using ``getStaticQueryParams()`` for isolation or, if already have Python installed, the latter option.
