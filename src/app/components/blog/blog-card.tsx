...
export default function BlogPostCard({ blogData }: { blogData: BlogData }) {
  ...
  return (
    <div className=" slower-transition  hover:slower-translate mx-auto mt-8 w-full max-w-[1280px] px-5 sm:mt-24 sm:px-10">
      <div className="group flex flex-col gap-4 rounded-[2rem] p-5 hover:scale-110 slower-transition shadow hover:shadow-[0px_4px_88px_0px_rgba(255,46,200,0.25)] border border-white/10 ">
